...
export const feeFacts: AmaraFact[] = [
  { id: 'fees-o-level', topic: 'fees', content: 'O-Level/Senior 1–4 school fees are UGX 1,500,000 per term. The approved O-Level uniform charge is UGX 400,000. Quote approved components separately; do not calculate or present a combined total, infer when charges fall due, describe uniform as part of each term’s school fee, or state a uniform frequency.', ...review },
  { id: 'fees-a-level', topic: 'fees', content: 'A-Level/Senior 5–6 school fees are UGX 1,500,000 per term. The approved A-Level uniform charge is UGX 420,000. Quote approved components separately; do not calculate or present a combined total, infer when charges fall due, describe uniform as part of each term’s school fee, or state a uniform frequency.', ...review },
