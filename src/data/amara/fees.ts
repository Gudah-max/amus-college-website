...
export const feeFacts: AmaraFact[] = [
  { id: 'fees-o-level', topic: 'fees', content: 'O-Level/Senior 1–4 school fees are UGX 1,500,000 per term. Uniform is a separate UGX 400,000 charge. Quote approved components separately; do not calculate or present a combined total, infer when charges fall due, or describe uniform as part of each term’s school fee.', ...review },
  { id: 'fees-a-level', topic: 'fees', content: 'A-Level/Senior 5–6 school fees are UGX 1,500,000 per term. Uniform is a separate UGX 420,000 charge. Quote approved components separately; do not calculate or present a combined total, infer when charges fall due, or describe uniform as part of each term’s school fee.', ...review },
