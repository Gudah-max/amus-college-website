...
export function deterministicFallback(message: string): string {
  ...
  if (/fee|cost|uniform|registration|pay|schoolpay|installment|instalment/.test(question)) return 'Current approved fees: Senior 1–4 is UGX 1,500,000 per term plus UGX 400,000 uniform; Senior 5–6 is UGX 1,500,000 per term plus UGX 420,000 uniform. New-student registration is UGX 100,000. For payment-plan options, please contact the school directly.';
