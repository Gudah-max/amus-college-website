...
export const schoolIdentity = {
  ...
  values: [
    ...
    ['Physical wellness', 'Discipline and teamwork developed through physical education and sport.'],
    ['Spiritual growth', 'Inner strength, purpose and reflection as part of whole-person development.'],
    ['Social responsibility', 'Compassionate community members who contribute positively to society.'],
  ],
} as const;
